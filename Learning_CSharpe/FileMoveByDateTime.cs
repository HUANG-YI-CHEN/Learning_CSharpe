private void button1_Click(object sender, EventArgs e)
{
    ...
    {
        foreach (var currentFile in Directory.EnumerateFiles(folderPath, "*.txt", SearchOption.TopDirectoryOnly))
        {
    ...
    // Timer RF https://blog.csdn.net/weixin_41561640/article/details/108378012
}
