...
namespace MachineLog.Lib
{
    ...
    public class FTPUtil
    {
        ...
        public FTPUtil(string ftpServerIP, string remoteFilePath, string ftpUserID, string ftpPassword, int ftpServerPort, bool anonymousAccess = false)
        {
        ...
        public string FtpServerIP { get { return ftpServerIP; } set { this.ftpServerIP = value; } }

        /// <summary>
        /// FTP服务器端口
        /// </summary>
        private int ftpServerPort;
        public int FtpServerPort { get { return ftpServerPort; } set { this.ftpServerPort = value; } }

        /// <summary>
        /// 当前服务器目录
        /// </summary>
        private string remoteFilePath;
        public string RemoteFilePath { get { return remoteFilePath; } set { this.remoteFilePath = value; } }

        /// <summary>
        /// Ftp 服务器登录用户账号
        /// </summary>
        private string ftpUserID;
        public string FtpUserID { set { this.ftpUserID = value; } }

        /// <summary>
        /// Ftp 服务器用户登录密码
        /// </summary>
        private string ftpPassword;
        public string FtpPassword { set { this.ftpPassword = value; } }

        /// <summary>
        /// 是否登录
        /// </summary>
        private bool bConnected;
        public bool Connected { get { return this.bConnected; } }
        #endregion
